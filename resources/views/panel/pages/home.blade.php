            ...
            <div class="container p-4 mt-4 bg-white">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Toplam İlan Sayısı: {{$advertCount}}</p>
                                        <p class="card-text">Toplam Teklif Sayısı: {{$proposalCount}}</p>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-md-6">
                        ...
                        <div class="mt-4">
                            <h5>İşlemler</h5>
                            <a href="{{route('panel.ilanlar.create')}}" class="btn btn-primary mr-2">Yeni İlan Oluştur</a>
                            <a href="{{route('panel.ilanlar.index')}}" class="btn btn-secondary">Tüm İlanları Görüntüle</a>
                        </div>
                    </div>
                </div>
            </div>
